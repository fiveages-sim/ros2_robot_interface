...
class ROS2RobotInterfaceConfig:
    ...
    body_current_pose_topic: str | None = None  # 【可选】body 当前笛卡尔位姿话题（PoseStamped），例如 "/body_current_pose"，用于 body pose 到位判定
    body_current_target_pose_topic: str | None = None  # 【可选】body 目标笛卡尔位姿话题（PoseStamped），例如 "/body_current_target"，用于 body pose 到位判定
