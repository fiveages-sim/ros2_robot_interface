"""
测试 arm_handler.send_target() 功能
向手臂发送绝对坐标下的目标位姿（不带坐标系信息），验证手臂能否正确运动到目标位置
支持单臂和双臂机器人
"""
...
def main() -> int:
    print("\n" + "=" * 70)
    print(" " * 18 + "arm_handler.send_target() 功能测试")
    print("=" * 70 + "\n")
    ...
    # ========================================================================
    print("=" * 70)
    print(f"[8] send_target() 测试（步长 {STEP_SIZE}m）")
    print("=" * 70)
